...
//  SearchTextField
//
//  Copied from Alejandro Pasccon with additional modifications
//
import UIKit
...
open class SearchTextField: UITextField {
    ...
    fileprivate func buildSearchTableView() {
        if let tableView = tableView, let shadowView = shadowView {
            ...
            tableView.allowsSelection = true//todo is necessary?
            tableView.allowsSelectionDuringEditing = true//todo is necessary?
            if forceRightToLeft {
